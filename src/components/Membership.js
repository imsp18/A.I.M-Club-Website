...
const MembershipCard = () => {
    ...
    return (
        <div className="flex flex-col h-[316px] bg-gradient-to-r from-secondary to-primary rounded-3xl max-sm:rounded-[18px] justify-center mt-20 max-sm:mt-10 max-sm:h-[190px]">
