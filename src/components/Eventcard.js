import EventImage from "../assests/event-image.png";
            ...
            <div className="flex flex-col w-[345px] h-[345px] p-4 rounded-3xl outline absolute bg-white outline-secondary outline-2">
                ...
                <div className="flex flex-row gap-2 items-center w-full mt-1">
                    ...
                    <div className="flex flex-row items-center gap-0.5">
                        ...
                        <div className="font-outfit text-center text-black text-sm font-normal">Aeronautical Department</div>
                    </div>
                    <div className="flex flex-row items-center gap-0.5">
                        <img src={ClockIcon} alt="location" className="h-6 w-6" />
                        <div className="font-outfit text-center text-black text-sm font-normal">10:45 - 11:45 </div>
                    </div>
                </div>
                {/* Event Title */}
                <div className="font-outfit items-start text-primary text-lg font-bold mt-2">Robotics Prototype Workshop </div>
                {/* Event Registration */}
